...
export class EventsService {
    ...
    getEvents(): Observable<IEvent[]> {
      ...
      return subject;
       ...
       /*
    getEvents(): Observable<IEvent[]> {
      return this.http.get<IEvent[]>('/api/evdents')
      .pipe(catchError(this.handleError<IEvent[]>('getEvents', [])))
    }
    */

    getEvent(id: number): IEvent {
        return EVENTS.find(evnt => id === evnt.id);
    ...
    */
    ...
    saveEvent(eventsForm) {
      eventsForm.id = 999;
      eventsForm.session = [];
      EVENTS.push(eventsForm);
    }
    ...
    */
    ...
    updateEvent(event) {
      const index = EVENTS.findIndex(evnt => evnt.id === event.id);
      EVENTS[index] = event;
      console.log(EVENTS);
    }
    ...
    */
    ...
    /*
    search would be done on server
     searchSessions(search; string): Observable<ISession[]> {
      ...
      sessions: [
        {
          ...
          voters: ['bradgreen', 'igorminar', 'martinfowler', 'ssoffel']
        },
        {
          id: 2,
